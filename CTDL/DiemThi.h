...
struct nodeDiemThi // Danh sách liên k?t don Ði?m thi
{
    DiemThi info;
    nodeDiemThi *next;
};
...
void insert_After_DT(PtrDT p, DiemThi x); //s? d?ng thu?ng xuyên hon vì môn h?c dã du?c s?p x?p t? tru?c
